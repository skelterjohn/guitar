  ...
  \new Staff \with {
    ...
    <<
      \new Voice { \voiceOne
        ...
        \repeat unfold 2{
          <a d' a' d'' fis'' a''>8_"pizz."\staccato  r4 r4. r2. |
          <b e' b' e'' gis'' b''>8\staccato  r4 r4. r2. |
        }
        \bar "||" \break
      }
  ...
  \new Staff \with {
    ...
    <<
      \new Voice { \voiceOne
        ...
        \repeat unfold 2{
          <a d' a' d'' fis'' a''>8_"pizz."\staccato r4 r4. r2. |
          <b e' b' e'' gis'' b''>8_"pizz."\staccato r4 r4. r2. |
        }
        \bar "||" \break
      }
    >>
