    ...
    } {
      {
        ...
        <<
          \new Voice { \voiceOne
            ...
            e-\markup { "rit." } b fis' g' d''2 \fermata |
            \break
            ...
            << 
              {
                ...
                g8\6 d'\5 d' g' g8\6 d'\5 g' d' | d'8\5 d' g' d' d'\5 g' d' d'\5 |
                \break
                ...
                g8 d' g' <a'-0> \grace <a'-1\3> \glissando b'4\3 d''4 |  f'8 g' c'' f' g' c'' e' d' |
                g8 d' g' a' \grace a'\3 \glissando b'4\3 d''4 |  f'8 g' c'' f' g' c'' e' d' |
                \break
                g8 d' g' a' \grace a'\3 \glissando b'4\3 d''8 d''8\2 | f'8 g' e'' c'' f' b' e' d' |
                g8 d' \grace a'( <d''\1 b'\2>) d' <d''\1 a'\3> g' g e'~ | e' g' c'' d'' ees' g' c'' d'' |
                \break
                ...
                g8 d' g' a' <c''\3 a'\2>8 <d''\2 g'\3>4 d''8 | g8 d' g' a' <c''\3 a'\2>8 <d''\2 g'\3>4 d''8 |
                g8 d' g' a' <c''\3 a'\2>8 <d''\2 g'\3>4 d''8 | g8-\markup { "rit." } d' g' a' d''2 \fermata |
                \break
