...
\new Staff {
  ...
  <<
    ...
    \new Voice { \voiceTwo
      ...
      a4 <g-3>8 a4 a8 | <ais-1>4. ais4 \grace <ais> \glissando <b>8 |
      s2 <b'-0>4 | <g'-0> s2 |
...
\new TabStaff {
  ...
  << 
    { 
      ...
      <fis''\2 d''\3>8 <e''\2 cis''\3> <g''\2 b'\4>2 | <fis''\2 d''\3>8 <e''\2 cis''\3> <g''\2 b'\4>2 |
      r8 a'\harmonic\5 d''\harmonic\4 fis''\3 cis''\4 a''\2 | g''4\2 d'''2 |
      \break
      e''2. | d''4\4 \harmonic g''\3 \harmonic r |
      
      <fis''\2 d''\3>8 <e''\2 cis''\3> <g''\2 b'\4>2 | <fis''\2 d''\3>8 <e''\2 cis''\3> <g''\2 b'\4>2 |
      
      \break
      r8 a'\harmonic\5 d''\harmonic\4 fis''\3 cis''\4 \glissando a'\4 | <b'>2.  |
      b'2.\p | <d''-4\3 a'-3\4>4\< <e''-0> <fis''-2 fis'-4> |
      \break
      fis''2\!\> fis''4 |
      ...
      <g'-4\4>4\<  <g'-0\3> <g'-0 fis'-3>4 | <g'-0 e'-1>4 <b' dis'> <g'' d'> |
      g''2.\! | \break
      <g'>4-> <bes'-4> <c''-2> |
    ...
    
    {
      ...
      d8 \staccato \tweak Y-offset #-6 r4 d4. | d8 \staccato \tweak Y-offset #-6 r4 d4. |
      a4 <g-3>8 a4 a8 | <ais-1>4. ais4 \grace <ais-1> \glissando <b>8 |
      s2 <b'-0>4 | <g'-0> s2 |
    ...
    
    {
      ...
      s2. | s2. |
      s2. | \tweak Y-offset #-2.2 r4 <g'-0 d'-0> <cis''-2\3 a'-3\4> |
      \tweak Y-offset #-2.2 r4 <g' d'> <cis''\3 a'\4> | s2. |
      \tweak Y-offset #-1.2 r4 bes'2 |
    ...
    
    {
      ...
      \tweak Y-offset #1.2 r4 <fis''-3 e''-0> <fis''\2 d''-2\3> | <fis''\2 cis''\3>2. |
      \tweak Y-offset #.6 r4 <cis''-1>2 | s2. |
      s2. | s2. |
      \tweak Y-offset #-1 r4 <g' f'>\p <g' f'> | s2. |
  ...
  <<
    {
      ...
      \fbarre #"VI" { c'''8 ais'' g''\2 d''\3 ees''\3 d''\3 } | ais'8\4 <g'-0> <f'-3> <ais-1> <dis-1> <dis'-1> |
      \break
      d'8 a e' a' <d'' a'> e'' | fis''8 d' bes' d'' <g''-2> \glissando fis'' |
      fis''8\> d' b' fis'' a''4 | a''2.\! |
      ...
      <e''' d''>8 \staccato[ gis''\3 \staccato] <fis''' cis''> \staccato[ g''\3 \staccato] <d''' c''>[ \staccato fis''\3 \staccato] |
      <b'' a'>8 \staccato[ f''\3 \staccato] <cis''' gis'> \staccato[ d''\3 \staccato] <a'' g'\4> \staccato[ cis''\3 \staccato] |
      <d''' c''>8 \staccato[ fis''\3 \staccato] <e''' b'\4> \staccato[ f''\3 \staccato] <c''' bes'> \staccato[ e''\3 \staccato] |
      <a'' f'' g'>2.
